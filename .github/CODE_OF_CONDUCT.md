...
2.  There's no need to notify the IBM Telemetry team that you have made an issue
    in IBM Telemetry's GitHub repositories. We check these several times a day, so
    we promise we'll address your issue as soon as we can.
